...
<html>
    ...
    <?php
     include('../connect/connect.php');
        ...
        //////////////////
        $sql = "SELECT muda, endTime FROM meetings"; // Replace your_table_name and time_column1, time_column2 with actual table and column names
                    ...
                    <form class="invitationForm" method='POST'>
                        ...
                        <div>
                            <span>
                                ...
                                <input type="date" name='tarehe' class="mInput tInput"  style='width:97px;'/>
                            </span>
                            <span>
                            <span>
                                start time
                            </span>
                                <input type="time" name='muda' class="mInput tInput"  style='width:97px;'/>
                            </span>
                            <span>
                            <span>
                                end time
                            </span>
                                <input type="time" name='mudaMwisho' class="mInput tInput"  style='width:97px;'/>
                            </span>
                        </div>
                        ...
                        <div class="btnContainer">
                            <span>
                                <input type="submit" value="Send Inivitation" class="sendButton"/>
                            </span>
                        </div>
